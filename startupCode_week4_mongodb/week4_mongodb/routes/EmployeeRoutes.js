...
app.get('/employees/firstname/:name', async (req, res) => {
  ...
  //console.log(`Static method - employees[0].firstname : ${employees[0].firstname}`)
  ...
  //console.log(`Instance method - employees[0].getFormattedSalary() : ${employees[0].getFormattedSalary()}`)
